...
# Description: Retrieves data from the /systempackage/{systemKey}/compliance/{complianceId}/records endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_compliance_by_complianceid_records_json.py \
