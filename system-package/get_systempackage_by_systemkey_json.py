...
# Description: Retrieves data from the /systempackage/{systemKey} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_systempackage_by_systemkey_json.py \
