...
# Description: Retrieves data from the /controls/cciforcontrol/{frameworkId}/control/{control} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_cciforcontrol_by_frameworkid_control_by_control_json.py \
