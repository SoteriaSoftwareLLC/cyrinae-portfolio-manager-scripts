...
# Description: Retrieves data from the /controls/framework/{frameworkId} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_framework_by_frameworkid_json.py \
