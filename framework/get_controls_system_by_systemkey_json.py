...
# Description: Retrieves data from the /controls/system/{systemKey} endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_system_by_systemkey_json.py \
