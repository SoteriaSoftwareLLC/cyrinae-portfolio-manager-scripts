...
# Description: Retrieves data from the /controls/all endpoint. The response is parsed as JSON and printed with standard indentation.
#
# Required Parameters:
...
#   python3 get_controls_all_json.py \
